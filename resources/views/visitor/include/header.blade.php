        ...
        <div class="container-fluid bg-golden-btn">
          ...
          <div class="collapse navbar-collapse bg-golden-btn"
            ...
            <ul class="navbar-nav ms-auto mb-2 pe-4 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('visitor.plot') }}">Plots</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('visitor.discount') }}">Discount</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('installments.user') }}">Installment</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('visitor.contact') }}">Contact</a>
              </li>

            </ul>
            <a href="/logout" class="btn px-4">Logout</a>
          </div>
        </div>
      </nav>
    </header>
